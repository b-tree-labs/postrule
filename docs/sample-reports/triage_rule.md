...
The pre-registered hypothesis at `dendra/hypotheses/triage_rule.md`
(generated by `dendra init` at the time of wrapping) predicted
...
`dendra/results/archive/triage_rule-2026-04-29.md` (rotation
