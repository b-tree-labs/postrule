...
| **VS Code extension** — IDE integration for `postrule init` / suggestions (customer-installable from the Marketplace; mirrors SDK positioning) | `cloud/vscode-postrule/**` | **Apache License, Version 2.0** | [`LICENSE-APACHE`](./LICENSE-APACHE) |
