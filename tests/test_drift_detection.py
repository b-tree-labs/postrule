...
"""Drift detection for generated files in ``__postrule_generated__/``.

When the user runs ``postrule init --auto-lift`` against a function, Postrule
...
generated file goes stale. ``postrule refresh`` regenerates on drift;
``postrule refresh --check`` is the CI gate; ``postrule doctor`` repairs
missing/orphaned files.

This file specifies the contracts. TDD-first, implementation in
``src/postrule/refresh.py``.
"""
...
class TestGeneratedHeaderRoundTrip:
    def test_write_and_parse_round_trip(self, tmp_path):
        ...
        out_path = tmp_path / "__postrule_generated__" / "routing__route_user.py"
        ...
        assert header.postrule_version == "1.0.0"
    ...
    def test_parse_missing_header_raises(self, tmp_path):
        ...
        with pytest.raises(ValueError, match=r"not.*Postrule.*generated"):
...
class TestDriftDetection:
    ...
    def _setup(self, tmp_path, src_text, gen_body):
        ...
        gen_path = tmp_path / "myapp" / "__postrule_generated__" / "routing__route_user.py"
        write_generated_file(
            gen_path,
            source_module="myapp.routing",
            source_function="route_user",
...
class TestMalformedHeaderHandling:
    def test_corrupted_hash_raises(self, tmp_path):
        ...
        gen_path.write_text(
            "# Generated by Postrule v1.0.0 - DO NOT EDIT\n"
